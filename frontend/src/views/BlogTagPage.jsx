...
export default function BlogTagPage({ tag: propTag, initialData }) {
  const paramsTag = useParams()?.tag;
  const rawTag = propTag || paramsTag;
    ...
    const fetchData = async () => {
      try {
        const [blogsRes, profileRes] = await Promise.all([
          fetch(`${API_URL}/api/blogs/tag/${encodeURIComponent(tag)}`),
          ...
          {blogs.length > 0 ? (
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <div className="flex items-center gap-1.5 px-2 py-1 bg-white/5 border border-white/10">
                            ...
                            <span className="text-[10px] text-white/50">{blog.reading_time} min</span>
                          </div>
                        </div>
                      </div>
            ...
            <div className="border border-white/10 bg-[#0d0d0d]">
              ...
              <div className="p-8 sm:p-12 text-center">
                ...
                <p className="text-white/30 text-xs mb-4">// No posts with this tag</p>
